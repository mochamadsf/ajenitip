        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-border">
            <tr className="hover:bg-surface/50 transition-colors">
              ...
              <td className="px-4 py-3 text-muted-foreground tabular-nums" colSpan={3}>
                {formatDateShortWIB(menuDate)}
              </td>
            </tr>
            <tr className="hover:bg-surface/50 transition-colors">
              <td className="px-4 py-3 font-medium text-foreground">Jam Produksi</td>
            ...
            <tr className="hover:bg-surface/50 transition-colors">
              <td className="px-4 py-3 font-medium text-foreground">Jam Pengiriman</td>
              <td className="px-4 py-3 text-muted-foreground tabular-nums">
            ...
            <tr className="hover:bg-surface/50 transition-colors">
              <td className="px-4 py-3 font-medium text-foreground">Status Pengiriman</td>
              <td className="px-4 py-3">
                <span className={menu.batch1_delivered ? "badge-safe" : "badge-warning"}>
              ...
              <td className="px-4 py-3">
                <span className={menu.batch2_delivered ? "badge-safe" : "badge-warning"}>
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold">
              ...
              <td className="px-4 py-3">
                <span className={menu.batch3_delivered ? "badge-safe" : "badge-warning"}>
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold">
            ...
            <tr className="hover:bg-surface/50 transition-colors">
              <td className="px-4 py-3 font-medium text-foreground">Masa Aman</td>
              <td className="px-4 py-3 text-muted-foreground" colSpan={3}>
                {menu.safe_hours} jam setelah pengiriman
              </td>
            </tr>
            {menu.nutritionist_name && (
              <tr className="hover:bg-surface/50 transition-colors">
                <td className="px-4 py-3 font-medium text-foreground">Ahli Gizi</td>
                <td className="px-4 py-3 text-muted-foreground" colSpan={3}>
                  {menu.nutritionist_name}
                </td>
              </tr>
